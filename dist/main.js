...
function letterPunch(array) {
  setTimeout(function () {
    (0, _jquery2.default)('#message-container').append('<span>' + array[0] + '</span>');
    setTimeout(function () {
      (0, _jquery2.default)('#message-container').append('<span>' + array[1] + '</span>');
      setTimeout(function () {
        (0, _jquery2.default)('#message-container').append('<span>' + array[2] + '</span>');
        setTimeout(function () {
          (0, _jquery2.default)('#message-container').append('<span>' + array[3] + '</span>');
          setTimeout(function () {
            (0, _jquery2.default)('#message-container').append('<span>' + array[4] + '</span>');
            setTimeout(function () {
              (0, _jquery2.default)('#message-container').append('<span>' + array[5] + '</span>');
              setTimeout(function () {
                (0, _jquery2.default)('#message-container').append('<span>' + array[6] + '</span>');
              }, 250);
            }, 750);
          }, 125);
        }, 125);
...
},{"howler":2,"jquery":3}],2:[function(require,module,exports){
(function (global){
/*!
 *  howler.js v2.0.0
 *  howlerjs.com
